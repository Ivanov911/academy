...
public class Task3 {
	...
	public static void main(String[] args) {
		...
		String date = "22/02/2024"; // ВВЕСТИ ДАТУ

		Pattern pattern = Pattern.compile("^(((0[1-9]|[12]\\d|3[01])\\/(0[13578]|1[02])\\/((1[6-9]|[2-9]\\d)\\d{2}))|" // 3a
																														// dd/MM/yyyy
		...
		Pattern pattern1 = Pattern.compile("^(((0[1-9]|[12]\\d|3[01])\\-(0[13578]|1[02])\\-((1[6-9]|[2-9]\\d)\\d{2}))|" // 3b
																														// dd-MM-yyyy
				+ "((0[1-9]|[12]\\d|30)\\-(0[13456789]|1[012])\\-((1[6-9]|[2-9]\\d)\\d{2}))|"
				+ "((0[1-9]|1\\d|2[0-8])\\-02\\-((1[6-9]|[2-9]\\d)\\d{2}))|"
				+ "(29\\-02\\-((1[6-9]|[2-9]\\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00))))$");
